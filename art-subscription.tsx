          ...
          <div className="space-y-8 p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-10">
              ...
              <Card className="bg-primary/5 border-primary/20 shadow-subtle rounded-lg overflow-hidden transition-all hover:shadow-md hover:translate-y-[-2px]">
                <CardContent className="pt-8 pb-6 px-6 text-center">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Not sure of your artistic taste? Our personalized curation helps you explore and refine your
                    preferences.
                  </p>
                </CardContent>
              </Card>
            ...
            <div className="bg-primary/5 rounded-lg p-8 border border-primary/20 shadow-subtle mt-10">
              ...
              <p className="mb-6 leading-relaxed">
                Our personalized art subscription service helps you discover new artists and styles while keeping your
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-primary mr-3 mt-1 shrink-0" />
                  <span className="leading-relaxed">Personalized curation based on your preferences</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-primary mr-3 mt-1 shrink-0" />
          ...
          <div className="space-y-8 p-6">
            <div className="space-y-3">
              ...
              <CardDescription className="text-base leading-relaxed">
                Select the art styles that resonate with you. This helps us curate your personalized collection.
              </CardDescription>
            </div>
        ...
        return (
          <div className="space-y-8 p-6">
            <div className="space-y-3">
              ...
              <CardDescription className="text-base leading-relaxed">
                Customize your artwork features to match your preferences and space.
              </CardDescription>
            </div>
                    ...
                    >
                      ...
                      >
                        ...
                        <p className="text-muted-foreground mt-2 leading-relaxed">
                          Established with growing recognition
                        </p>
                        <Badge variant="outline" className="mt-4 w-fit border-primary/30 text-primary">
                          1.8x Multiplier
                        </Badge>
                ...
                <div>
                  <div className="sticky top-6">
                    ...
                    <Button
                      ...
                      onClick={() => alert("Wall visualization tool would open here")}
                    >
              ...
              <Alert className="bg-primary/10 border-primary/20 shadow-subtle">
                <div className="flex flex-col items-center text-center py-6">
                  ...
                  <p className="text-muted-foreground mt-4 leading-relaxed">
                    We're excited to start curating your personalized art collection. Your first quarterly artwork
